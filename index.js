...
<title>VILLAIN MULTI COOKIE CONVO SYSTEM</title>
<style>
* {
...
html, body {
  height: 100%;
  margin: 0;
  background: #111; /* main dark */
  color: #e2e2e2; /* readable gray */
}
...
<body>
  ...
  <header>
    <h1>🔥FB VILLAIN MULTI COOKIE CONVO SYSTEM 
